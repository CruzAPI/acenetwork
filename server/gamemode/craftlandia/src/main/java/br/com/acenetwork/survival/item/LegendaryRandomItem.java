...
public class LegendaryRandomItem extends Activatable
{
	private static LegendaryRandomItem instance;
	public static final String SKIN_VALUE = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTdiYzFiNjRjYmEzZGM0Y2VmZTRlMTIxYzNjZGJiYjBmYTk5YWJhMGUxMTNiNWM5MTY4MTVmYzliMzA0ZTYzNiJ9fX0=";
	
	private LegendaryRandomItem()
	{
		super("legendary_random_item");
	}
	...
	public ItemStack getItemStack(ResourceBundle bundle, Object... args)
	{
		...
		meta.setDisplayName(CommonsUtil.hideUUID(uuid) + ChatColor.RESET + CommonsUtil.hideUUID(random)
				+ ChatColor.GOLD + ChatColor.BOLD + "LEGENDARY RANDOM ITEM");
