...
public class RareRandomItem extends Activatable
{
	private static RareRandomItem instance;
	public static final String SKIN_VALUE = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNmNmYjRlYmMzYmE0ZmVjMDRkODk3OGExNjYwYmI3Yzk4ZTk2MzQyZmYyYTIzOGFkYTlkZjJmNzRiZjAzMmI0MCJ9fX0=";
	
	private RareRandomItem()
	{
		super("rare_random_item");
	}
	...
	public ItemStack getItemStack(ResourceBundle bundle, Object... args)
	{
		...
		{
			item = new ItemStack(Material.WOOL, 1, (short) 10);
			meta = item.getItemMeta();
		...
		meta.setDisplayName(CommonsUtil.hideUUID(uuid) + ChatColor.RESET + CommonsUtil.hideUUID(random)
				+ ChatColor.DARK_PURPLE + ChatColor.BOLD + "RARE RANDOM ITEM");
