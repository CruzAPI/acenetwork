...
public class CommonRandomItem extends Activatable
{
	public static final String SKIN_VALUE = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjAzZjVhOWJjNzE5Y2QxMTI3YmUwOTU0YzczY2Q1NzE0ZWNkNDc4ZGFkODgwZWYyYjk5NzljNDgxMDk3ZTZiZSJ9fX0=";
	
	@SuppressWarnings("unused")
	private static CommonRandomItem instance;
	
	private CommonRandomItem()
	{
		super("common_random_item");
	}
	...
	public ItemStack getItemStack(ResourceBundle bundle, Object... args)
	{
		...
		meta.setDisplayName(CommonsUtil.hideUUID(uuid) + ChatColor.RESET + CommonsUtil.hideUUID(random)
				+ ChatColor.GREEN + ChatColor.BOLD + "COMMON RANDOM ITEM");
