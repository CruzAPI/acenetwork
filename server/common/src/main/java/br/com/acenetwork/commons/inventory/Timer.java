...
public abstract class Timer extends GUI
{
	...
	public ItemStack days()
	{
		...
		if(isPermanent())
		{
			item = new ItemStack(Material.INK_SACK, days, (short) 5);
		...
		{
			item = new ItemStack(Material.INK_SACK, days, (short) 8);
			ItemMeta meta = item.getItemMeta();
		...
		{
			item = new ItemStack(Material.INK_SACK, days, (short) 10);
			ItemMeta meta = item.getItemMeta();
	...
	public ItemStack hours()
	{
		...
		if(isPermanent())
		{
			item = new ItemStack(Material.INK_SACK, hours, (short) 5);
			ItemMeta meta = item.getItemMeta();
		...
		{
			item = new ItemStack(Material.INK_SACK, hours, (short) 8);
			ItemMeta meta = item.getItemMeta();
		...
		{
			item = new ItemStack(Material.INK_SACK, hours, (short) 10);
			ItemMeta meta = item.getItemMeta();
	...
	public ItemStack minutes()
	{
		...
		if(isPermanent())
		{
			item = new ItemStack(Material.INK_SACK, minutes, (short) 5);
			ItemMeta meta = item.getItemMeta();
		...
		{
			item = new ItemStack(Material.INK_SACK, minutes, (short) 8);
			ItemMeta meta = item.getItemMeta();
		...
		{
			item = new ItemStack(Material.INK_SACK, minutes, (short) 10);
			ItemMeta meta = item.getItemMeta();
